...
public var minimumSpawnDelayTime:int = 9000;
public var maximumSpawnDelayTime:int = 9000;
...
private var doorCollected:int = 0;
...
{    
    ...
    if (type == 1)
    {
        score+=1; // simply add 2 to the score
    }
    else if (type == 2)
    {
        score+=1; // add a random score between -2 and 5 to the score
    }
    else if (type == 3)
    {
        score+=1; // add a random score between -2 and 5 to the score
